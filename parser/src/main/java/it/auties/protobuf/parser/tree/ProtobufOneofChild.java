 ...
 * {@link ProtobufOneofStatement}. Oneof blocks ensure that only one field is set at a time.
...
public sealed interface ProtobufOneofChild
        ...
        permits ProtobufFieldStatement, ProtobufGroupStatement, ProtobufOptionStatement {
