...
final class EnumSchemaCreator extends SchemaCreator<ProtobufEnumStatement> {
    EnumSchemaCreator(@NonNull ProtobufEnumStatement protoStatement, @NonNull List<CompilationUnit> classPool, Path output) {
        super(protoStatement, false, classPool, output);
    }
