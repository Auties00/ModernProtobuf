...
import it.auties.protobuf.util.ArrayOutputStream;
...
import static it.auties.protobuf.model.ProtobufProperty.Type.MESSAGE;
...
public class ProtobufGenerator extends GeneratorBase {
    ...
    private Object getFieldValue(Object object, Field field, ProtobufProperty property, Class<?> type) {
        ...
        if (property.type() != MESSAGE || !ProtobufUtils.hasValue(type)) {
            return value;
        }
