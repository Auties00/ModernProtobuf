...
import it.auties.protobuf.serialization.jackson.exception.ProtobufDeserializationException;
import it.auties.protobuf.serialization.jackson.model.ProtobufField;
import it.auties.protobuf.serialization.jackson.model.VersionInfo;
import it.auties.protobuf.serialization.jackson.stream.ArrayInputStream;
...
import static it.auties.protobuf.serialization.jackson.model.WireType.*;
...
class ProtobufParser extends ParserMinimalBase {
    ...
    private final RepeatedCollectionModule module;
    ...
    public ProtobufParser(IOContext ioContext, RepeatedCollectionModule module, int parserFeatures, ObjectCodec codec, byte[] input) {
    ...
    private Object readEmbeddedMessage(byte[] bytes) {
        ...
        var lastRepeatedEntries = module.entries();
        try {
            ...
            System.out.printf("Old entries: %s New entries: %s Result: %s%n", lastRepeatedEntries, module.entries(), result);
            return result;
            ...
            module.setEntries(lastRepeatedEntries);
        }
    }
