...
public class GenerateSchemaCommand implements Callable<Integer> {
    ...
    @Option(names = {"-p", "--package"}, description = "The package of the generated classes, by default none is specified")
    private String pack = "";
    ...
    public Integer call() {
        ...
        try{
            ...
            generateSchema(ast);
            return 0;
        }catch (IOException | GeneratorException | FormatterException ex) {
    ...
    private void suppressIllegalAccessWarning() {
        try {
            ...
            log.error("Cannot suppress illegal access warning!");
        }
    }
    ...
    private void generateSchema(ProtobufDocument ast) throws GeneratorException, IOException, FormatterException {
