...
Performance wise, ModernProtoc matches Jackson's Protobuf, but they both fall short when compared to Google's implementation which is more than two times faster.
