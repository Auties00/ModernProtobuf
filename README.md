...
1. Download the CLI tool from the release tab or compile the project yourself using Maven
...
2. Run the following command:
    ...
    ```
   This will update all models in `input_directory`. If you want your updated models to be mutable, add `--mutable`

### How to encode/decode a message

After you have generated the model, compile your project.
Let's say your model is named ScalarMessage, then a class named ScalarMessageSpec will be generated. 
Now you can easily encode/decode ScalarMessage using ScalarMessageSpec:
```
...
<details>
  <summary>ModernProtobuf immutable java record (28 LOC)</summary>
...
**ModernProtobuf's model is 65x times smaller than Google's!**
