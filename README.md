...
<details>
  <summary>ModernProtobuf immutable java record (28 LOC + 173 LOC generated at compile time for ScalarMessageSpec and ScalarMessageBuilder)</summary>
...
PerformanceBenchmark.modernProtobuf             avgt    5  104.093 ± 0.630  us/op
...
2. `@ProtobufDefaultValue`
   ...
   If you want to change the default behaviour for the latter, you can do so using this annotation:
   ```java
...
A custom mixin can be defined by declaring a class that implements `ProtobufMixin`.
